...
import { insertContentProjectionPersonalTool } from '../projection/lib/adapters/thetree-content-projection.js';
...
export function makePersonalToolsItems(context = {}) {
  ...
  const withProjection = insertContentProjectionPersonalTool(baseItems, context);
  const withDarkMode = insertDarkModePersonalTool(withProjection, {
