...
> [!NOTE]
> Vector는 데스크톱 환경용입니다. 모바일 환경에서는 [Skin Composer](https://github.com/WikinLab/thetree-skin-composer)로 Minerva 같은 모바일 스킨과 결합한 구성을 권장합니다.
...
모바일 환경을 함께 제공하려면 [`thetree-skin-composer`](https://github.com/WikinLab/thetree-skin-composer)로 Vector와 Minerva 같은 모바일 스킨을 결합합니다.
